...
Deno.test('should validate ISO 8601 dates', () => {
...
Deno.test(
  'should validate ISO 8601 dates, with strict = true (regression)',
  () => {
    test({
      validator: 'isISO8601',
      args: [{ strict: true }],
...
Deno.test('should validate ISO 8601 dates, with strict = true', () => {
  test({
    validator: 'isISO8601',
    args: [{ strict: true }],
